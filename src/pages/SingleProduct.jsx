    ...
    <div className="h-lvh p-12">
      <div className="card card-side bg-slate-100 shadow-xl">
        ...
        <div className="flex flex-col justify-between py-10">
          <div className="px-10">
            <h2 className="md:text-xl lg:w-full  text-gray-950 font-serif font-bold text-4xl text-center mb-10">
              {product.title}
            </h2>
            <p className="text-center  text-gray-950 w-full mb-10 italic">
              {product.description}
            </p>

            <div className="bg-slate-200 p-5 rounded-[25px] mb-10">
              <p className="font-semibold  text-gray-950 font-serif ">Price:</p>
              <p className="font-medium  text-gray-950 flex gap-10">
                {(
                  product.price -
